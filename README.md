...
Credentials and temporary device state are stored as a AES-256-GCM envelope in paymos_config keyed from CS-Cart crypt_key. Saved secrets are not rendered back into the administration page.
